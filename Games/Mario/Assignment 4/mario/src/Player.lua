...
--make sure the character falls on the ground initially
function Player:CheckInitialFall() 

    for x = 1, self.map.width do 
        if self.map.tiles[5][x].id == TILE_ID_GROUND or self.map.tiles[7][x].id == TILE_ID_GROUND then
