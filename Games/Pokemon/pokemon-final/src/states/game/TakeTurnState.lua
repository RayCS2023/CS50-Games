...
function TakeTurnState:attack(attacker, defender, attackerSprite, defenderSprite, attackerkBar, defenderBar, onEnd) 
    --display attacked msg
    gStateStack:push(BattleMessageState(attacker.name .. ' attacks ' .. defender.name .. '!', function() end, false))
    ...
    Timer.after(0.5, function()
        ...
        --blink 3 times (turns on and off for 6 times)
        ...
        :finish(function() 
            ...
            --blink the opacity (triggered 6 times as well)
            Timer.every(0.1, function()
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        function()
                            gStateStack:push(LevelMenuState({
                                HPIncrease = HPInc,
                                attackIncrease = attackInc,
